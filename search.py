...
def searchHelper(problem, fringe):
    ...
    expanded = set()
    fringe.push([(problem.getStartState(), "Stop" , 0)]) #because you've eaten the food
...
def depthFirstSearch(problem):
    ...
    Start's first successor: ((5, 4), 'South', 1)
    Start's first successor's coordinates: (5, 4)
    ...
    print("Is the start a goal?", problem.isGoalState(problem.getStartState()))
    print("Start's successors:", problem.getSuccessors(problem.getStartState()))
    print("Start's first successor:", problem.getSuccessors(problem.getStartState())[0])
    print("Start's first successor's coordinates:", problem.getSuccessors(problem.getStartState())[0][0])
